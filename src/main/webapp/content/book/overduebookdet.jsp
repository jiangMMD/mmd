    ...
    <div class="col-xs-12">
                    ...
                    <div class="widget-main">
                        <div class="row">
                            ...
                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-name">当前逾期费用</label>
                                <input class="form-control"  value="${book.expectfee}">
                            </div>

                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-name">历史总逾期费用</label>
                                <input class="form-control"  value="${book.totalexpectfee}">
                            </div>

                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-name">已还期数</label>
                                <input class="form-control"  value="${book.repaylssue}">
                            </div>

                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-name">当前应还金额</label>
                                <input class="form-control"  value="${book.repaytotal}">
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-agency_id">应还款日<span class="red">*</span></label>
                                <input class="form-control"  value="${book.repaydate}">
                            </div>
                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-agency_id">历史还款金额<span class="red">*</span></label>
                                <input class="form-control"  value="${book.reimbursement}">
                            </div>

                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-agency_id">订单开始时间<span class="red">*</span></label>
                                <input class="form-control"  value="${book.startdate}">
                            </div>

                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-agency_id">逾期天数<span class="red">*</span></label>
                                <input class="form-control"  value="${book.expectday}">
                            </div>
        ...
        <div class="row" id="book_save_info">
            <div class="col-xs-4 col-xs-offset-5">
                <input onclick="finishBook()" type="button" class="btn btn-success" style="margin-left: 20px;" value="结清订单">
            </div>
        </div>
    </div>
</div>
