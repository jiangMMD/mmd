...
<div class="page-header">
    <h5>
        <div class="row">
            ...
            <span class="alert alert-info" style="margin-left: 10px"><strong>操作说明：</strong><strong>审核拒绝</strong>，将直接拒绝该租赁合同，后续无法对该单子执行任何操作，
            <strong>审核通过</strong>，通过审核之后，代理商方可后续上传IEM截图及其拆机视频。 <strong>返回修改</strong>，代理商可以通过修改信息，重新提交该单子，进行再次审核</span>
        </div>
...
<div class="row">
    <div class="col-xs-12">
        <form class="form-horizontal" id="validation-form-book" method="post" enctype="multipart/form-data">
            ...
            <div class="widget-box" id="widget-person">
                <div class="widget-header">
                    <h4 class="widget-title">个人信息</h4>

                    <%--<label class="inline middle" style="margin-left: 20px">--%>
            ...
            <div class="widget-box" id="widget-product">
                <div class="widget-header">
                ...
                <div class="widget-body">
                    <div class="widget-main" style="min-height: 200px;">
                        <div class="row">
                            ...
                            <div class="col-xs-4 form-group">
                                <label class="control-label" for="form-book-product_price">商品价值(签约价)<span
                                        class="red">*</span></label>
                                <input class="form-control" id="form-book-product_price" name="product_price"
                                       value="${book.product_price}"
                                       placeholder="请输入商品价值"/>
                            </div>
            ...
            <div class="widget-box" id="widget-clan">
                <div class="widget-header">
            ...
            <div class="space-20"></div>
            <!--常用联系人信息-->
            <div class="widget-box" id="widget-link">
                <div class="widget-header">
            ...
            <div class="space-20"></div>
            <!--常用联系人信息-->
            <div class="widget-box" id="widget-credit">
                <div class="widget-header">
                    <h4 class="widget-title">征信信息</h4>

                    <span class="orange">(完善征信信息，将有助于您提高申请成功率，如果不填写，将有极大可能造成审核失败)</span>
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <div class="row">
                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-taobao_loginno">淘宝登录名</label>
                                <input class="form-control" id="form-book-taobao_loginno" name="taobao_loginno"
                                       value="${book.taobao_loginno}">
                            </div>
                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-taobao_password">淘宝登录密码</label>
                                <input class="form-control" id="form-book-taobao_password" name="taobao_password"
                                       value="${book.taobao_password}">
                            </div>

                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-zhifubao_loginno">支付宝登录名</label>
                                <input class="form-control" id="form-book-zhifubao_loginno" name="zhifubao_loginno"
                                       value="${book.zhifubao_loginno}"/>
                            </div>

                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-zhifubao_password">支付宝登录密码</label>
                                <input class="form-control" id="form-book-zhifubao_password" name="zhifubao_password"
                                       value="${book.zhifubao_password}"/>
                            </div>

                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-xuexin_loginno">学信网登录名</label>
                                <input class="form-control" id="form-book-xuexin_loginno" name="xuexin_loginno"
                                       value="${book.xuexin_loginno}"/>
                            </div>

                            <div class="col-xs-2 form-group">
                                <label class="control-label" for="form-book-xuexin_password">学信网登录密码</label>
                                <input class="form-control" id="form-book-xuexin_password" name="xuexin_password"
                                       value="${book.xuexin_password}"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-20"></div>
            <div class="widget-box" id="widget-accessory">
                <div class="widget-header">
            ...
            <!--是否显示补全附件信息-->
            <c:if test="${book.audit_state == '7'}">
                <div class="space-20"></div>
                <div class="widget-box" id="widget-accessory_com">
                    <div class="widget-header">
                    ...
                    <div class="widget-body" id="book_must_readjunct">
                        <div class="widget-main" style="min-height: 200px;">
                            <div class="row">
                                ...
                                <div class="col-xs-4 form-group">
                                    <label class="control-label" for="form-book-identity_front">合同拍照<span
                                            class="red">*</span></label>
        ...
        <div class="space-12"></div>
        <c:if test="${book.audit_state == '1'}">
            <div class="row" id="book_audit_info">
                <div class="col-xs-4 col-xs-offset-5">
                    <button class="btn btn-success" onclick="passAudit()">审核通过（初审）</button>
                    <button class="btn btn-danger" style="margin-left: 20px;" onclick="unPassAudit()">审核拒绝（初审）</button>
                    <button class="btn btn-info" style="margin-left: 20px;" onclick="backUpdate()">返回修改（初审）</button>
                </div>
            </div>
        </c:if>
        ...
        <c:if test="${book.audit_state == '7'}">
            <div class="row" id="book_audit_info">
                <div class="col-xs-4 col-xs-offset-5">
                    <button class="btn btn-success" onclick="passReAudit()">审核通过（复审）</button>
                    <button class="btn btn-danger" style="margin-left: 20px;" onclick="unPassReAudit()">审核拒绝（复审）
                    </button>
                    <button class="btn btn-info" style="margin-left: 20px;" onclick="backReUpdate()">返回修改（复审）</button>
                </div>
            </div>
        </c:if>
...
<script>
    ...
    function passAudit() {
        ...
        bootbox.confirm("确认审核通过（初审）该订单？", function (result) {
            if (result) {
                myAjax("/book/passAudit", {id: id}, function (result) {
                    if (result.code === 1) {
                        showSuccInfo("操作成功");
                        $("#book_audit_info").hide();
                    } else {
    ...
    function unPassAudit() {
        ...
        bootbox.dialog({
            title: "客户审核失败",
            message: "<input id='audit_cause' type='password' class='form-control' placeholder='请输入该客户审核（初审）失败的原因？'/>",
            buttons: {
                ok: {
                    callback: function () {
                        myAjax("/book/unPassAudit", {
                            bid: id,
                            unpassaudit_memo: $("#audit_cause").val()
                        }, function (result) {
                            if (result.code === 1) {
                                showSuccInfo("操作成功");
                                $("#book_audit_info").hide();
    ...
    function backUpdate() {
        ...
        bootbox.dialog({
            ...
            buttons: {
                ok: {
                    callback: function () {
                        var updVals = $("#form-book-upditems").val();
                        var memo = $("#form-book-updMemo").val();
                        myAjax("/book/backUpdate", {bid: id, updmemo: memo, updItem: updVals.join(",")}, function (result) {
                            if (result.code === 1) {
                                showSuccInfo("操作成功");
                                $("#book_audit_info").hide();
                            } else {
        ...
        $("#form-book-upditems").chosen({allow_single_deselect: true, width: "100%"});
    }

    function getItemHtml() {
        var html = "";
        html += '<select id="form-book-upditems" multiple  class="form-control" data-placeholder="请选择你需要返回修改的项">';
        $("#widget-person").find(".control-label").each(function () {
            var itemname = $(this).text().replace("*", "")
            html += '<Option value="widget-person_' + itemname + '">个人信息-----' + itemname + '</Option>';
        });
        $("#widget-product").find(".control-label").each(function () {
            var itemname = $(this).text().replace("*", "")
            html += '<Option value="widget-product_' + itemname + '">商品信息-----' + itemname + '</Option>';
        });
        $("#widget-clan").find(".row").each(function (i) {
            $(this).find(".control-label").each(function () {
                var itemname = $(this).text().replace("*", "");
                html += '<Option value="widget-clan_' + itemname + '">亲属' + (i + 1) + '-----' + itemname + '</Option>';
            })
        });
        //常用联系人信息
        $("#widget-link").find(".row").each(function (i) {
            $(this).find(".control-label").each(function () {
                var itemname = $(this).text().replace("*", "");
                html += '<Option value="widget-link_' + itemname + '">常用联系人' + (i + 1) + '-----' + itemname + '</Option>';
            })
        });
        //征信信息填写
        $("#widget-credit").find(".control-label").each(function() {
            var itemname = $(this).text().replace("*", "")
            html += '<Option value="widget-credit_' + itemname + '">征信信息-----' + itemname + '</Option>';
        })
        //附件信息
        $("#widget-accessory").find(".control-label").each(function(){
            var itemname = $(this).text().replace("*", "")
            html += '<Option value="widget-accessory_' + itemname + '">附件信息-----' + itemname + '</Option>';
        });
        html += '</select>';
        //备注信息
        html += '<div class="space-12"></div>';
        html += '<textarea class="form-control" id="form-book-updMemo" placeholder="请输入待返回修改原因"></textarea>'
        return html;
    }

    //通过审核复审
    function passReAudit() {
        var id = $("input[name=bid]").val();
        bootbox.confirm("确认审核(复审)通过该订单？ 通过之后，将从今日开始产生费用", function (result) {
            if (result) {
                myAjax("/book/passReAudit", {id: id}, function (result) {
                    if (result.code === 1) {
                        showSuccInfo("操作成功");
                        $("#book_audit_info").hide();
                    } else {
    ...
    //审核拒绝复审
    function unPassReAudit() {
        var id = $("input[name=bid]").val();
        bootbox.dialog({
            title: "审核（复审）失败",
            message: "<input id='unpassaudit_memo'  class='form-control' placeholder='请输入该客户审核（复审）失败的原因？'/>",
            buttons: {
                ok: {
                    callback: function () {
                        var audit_cause = $("#unpassaudit_memo").val();
                        myAjax("/book/unPassReAudit", {bid: id, unpassaudit_memo: audit_cause}, function (result) {
                            if (result.code === 1) {
                                showSuccInfo("操作成功");
                                $("#book_audit_info").hide();
                            } else {
    ...
    //返回修改复审
    function backReUpdate() {
        var id = $("input[name=bid]").val();
        bootbox.dialog({
            title: "审核（复审）失败",
            message: "<input id='updmemo_last'  class='form-control' placeholder='请输入该客户需要修改(复审)的信息？'/>",
            buttons: {
                ok: {
                    callback: function () {
                        var updmemo_last = $("#updmemo_last").val();
                        myAjax("/book/unPassReAudit", {bid: id, updmemo: updmemo_last}, function (result) {
                            if (result.code === 1) {
                                showSuccInfo("操作成功");
                                $("#book_audit_info").hide();
                            } else {
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        ...
        $(function () {
            ...
            if (!'${book.bid}') {
                ...
                <%--$('#form-book-taobao_address').after("<a href='/nginxBookAccesstory/${book.accessory.taobao_address}' onclick="openFile(\''+taobao_address+'\')" class='blue2' style='display:block;cursor: pointer'>文件已上传，点击查看</a>");--%>
